...
public class SparqlClassProject extends Project implements SparqlClassRel {

  protected SparqlClassProject(RelOptCluster cluster, RelTraitSet traits, RelNode input,
  ...
  public Project copy(RelTraitSet traitSet, RelNode input, List<RexNode> projects, RelDataType rowType) {
    return new SparqlClassProject(getCluster(), traitSet, input, projects, rowType);
  }
